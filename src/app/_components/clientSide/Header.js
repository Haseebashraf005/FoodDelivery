                ...
                >
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg 
                        ...
                        <li className="relative">
                            <a
                                href="#"
                                className="flex items-center gap-2 py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 
                             md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 
                             dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 
                             dark:hover:text-white md:dark:hover:bg-transparent"
                            >
                       ...
                       0L6.75 12.75h10.5l2.25-7.5H5.106zm0 
                       0L4.5 6.75m2.25 12a.75.75 0 100 
                       1.5.75.75 0 000-1.5zm10.5 
                       0a.75.75 0 100 1.5.75.75 0 000-1.5z"
                                    />
                                </svg>
                                Cart
                                {/* Badge */}
                                <span
                                    className="absolute -top-1 right-0 md:-top-2 md:-right-3 
                        ...
                        <li>
                            ...
                            <div
                                id="dropdownNavbar"
                                className="z-10 hidden font-normal bg-white divide-y divide-gray-100 
